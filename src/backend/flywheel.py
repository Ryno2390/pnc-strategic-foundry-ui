...
ADAPTER_DIR = BACKEND_DIR / "s1_adapter"
...
PROMPTS_FILE = DATA_DIR / "banking_prompts.jsonl"
TRACES_FILE = DATA_DIR / "s1_traces.jsonl"
GRADED_FILE = DATA_DIR / "graded_traces.jsonl"
